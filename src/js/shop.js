...
const shopSmallCardInfo = document.querySelector('.shop__item__small-card__info');
...
const shopSmallCardSize = document.querySelector('.shop__item__small-card__size');
...
const shopBackSmallCard = document.querySelector('.shop__item__small-card__size__return');
