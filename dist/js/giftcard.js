...
const modalSendGiftToSocial = document.querySelector(
  ".gift__info__send__modal",
);
...
item1.addEventListener("click", () => {
  catalogImg1.classList.add(
    "reviews__rating__catalog__item__small__img__active",
  );
  catalogInfo1.classList.add(
    "reviews__rating__catalog__item__small__info__active",
  );
  addButton1.classList.add(
    "reviews__rating__catalog__item__small__quick-btn__active",
  );
});

addButton1.addEventListener("click", () => {
  addButton1.classList.remove(
    "reviews__rating__catalog__item__small__quick-btn__active",
  );
  catalogInfo1.classList.remove(
    "reviews__rating__catalog__item__small__info__active",
  );
  selectsixe1.classList.add(
    "reviews__rating__catalog__item__selectsize__active",
  );
});

const returnBackCatalog = document.querySelectorAll(
  ".reviews__rating__catalog__item__selectsize__return",
);
...
returnBackCatalog.forEach((element) => {
  element.addEventListener("click", () => {
    ...
    selectsixe1.classList.remove(
      "reviews__rating__catalog__item__selectsize__active",
    );
    catalogImg1.classList.remove(
      "reviews__rating__catalog__item__small__img__active",
    );
  });
});
